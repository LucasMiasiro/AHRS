...
# K = Ppriori*transpose(H)*simplify((H*Ppriori*transpose(H) + R).inv())
# simplify(K)

# sensor = Matrix([xmeas, vmeas])
# stateposteriori = statepriori + K*(sensor - H*statepriori)
