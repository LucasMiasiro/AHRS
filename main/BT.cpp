...
struct navDataBT_ptr {
    navData_ptr *navData;
    TaskHandle_t *sendTask_h;
    TaskHandle_t *navTask_h;
    TaskHandle_t *sensorTask_h;
    TaskHandle_t *gyroCalTask_h;
    TaskHandle_t *magCalTask_h;
};
static navDataBT_ptr *__navDataBT_ptr;
...
void startBT(navDataBT_ptr* navDataBT){
    __navDataBT_ptr = navDataBT;
